...
function Nav() {
    ...
    const transitionNavbar= () => {
        if (window.scrollY > 100) {     //if the window scroll vertical more than 100
    ...
    return (
        <div className={`nav ${show && 'nav__black'}`}> {/*this says that only render navblack clss if this show variable is true */}
