...
function Banner() {
    ...
    function truncate(string, n){   //n is the no of character
        ...
        <header
            ...
            <div className="banner__contents">
                <h1 className="banner__title">
                    {movie?.title || movie?.name || movie?.original_name} {/*it could either be a movie?.title or it could be movie name or it could be movie original name */}
                    {/* {movie?.origin_country} */}
                </h1>
                <h1 className="banner__description">
                    {truncate(movie?.overview,150)}</h1> {/*it will truncate the movie overview */}
                <div className="banner__buttons">
                    <button className="banner__button banner__button-play"><FontAwesomeIcon icon={faPlay}/> Play</button>
                    <button className="banner__button banner__button-info"><FontAwesomeIcon icon={faInfoCircle}/> More Info</button>
                </div>
            </div>
